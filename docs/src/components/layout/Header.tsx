...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 inset-x-0 h-14 z-40 border-b border-zinc-200 dark:border-zinc-800/80 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md">
      <div className="w-full h-14 flex items-center">
        {/* Left Column: w-auto on mobile, w-64 on desktop to align with Sidebar */}
        <div className="w-auto md:w-64 shrink-0 px-3 sm:px-4 h-full flex items-center justify-between border-r border-transparent md:border-zinc-200 md:dark:border-zinc-800/80">
          <div className="flex items-center gap-2.5 sm:gap-3">
            {/* Mobile hamburger */}
            <button
              onClick={onToggleMobileMenu}
              aria-label="Open mobile navigation"
              className="md:hidden p-1.5 rounded-lg text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer"
            >
        ...
        <div className="flex-1 px-3 sm:px-6 lg:px-8 xl:px-10 h-full flex items-center justify-between gap-2 sm:gap-4 min-w-0">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors cursor-pointer ${
                currentPath.startsWith('/docs')
                  ? 'text-zinc-900 dark:text-zinc-100 bg-zinc-100 dark:bg-zinc-900 font-semibold'
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 ml-auto">
            ...
            <button
              ...
              className="sm:hidden p-2 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 text-zinc-500 dark:text-zinc-400 hover:border-zinc-300 dark:hover:border-zinc-700 cursor-pointer"
            >
            ...
            <button
              onClick={onOpenSearch}
              className="hidden sm:flex items-center gap-2 px-2.5 py-1.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 text-xs text-zinc-500 dark:text-zinc-400 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors w-40 lg:w-56 justify-between cursor-pointer"
            >
